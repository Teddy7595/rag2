...
Installation, environment configuration, and route reference for the RAG2 modular monolith. For the architecture overview and project pitch, see the [root README](../README.md).
