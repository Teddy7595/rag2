...
from app.knowledge.adapters.persistence import SqlAlchemyKnowledgeRepository
...
def register_knowledge_module(app: FastAPI) -> None:
    ...
    service = KnowledgeService(repository=repository, event_bus=context.event_bus)
